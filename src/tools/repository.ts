...
export const repositoryTools = (client: GitLabClient) => [
  {
    name: "gitlab_get_file",
    description:
      "Read the contents of a file in a GitLab repository. Returns decoded file content.",
...

  {
    ...
    description:
      "List files and directories in a GitLab repository directory.",
    inputSchema: z.object({
...

  {
    ...
    handler: async (input: { project_id: string | number; sha: string }) => {
...

  {
    ...
    description:
      "Search for code within a GitLab project. Returns file snippets matching the query.",
    inputSchema: z.object({
      project_id: z.union([z.string(), z.number()]).describe("Project ID or path"),
...

  {
    ...
    description:
      "Compare two branches, tags, or commits. Returns diff and list of commits between them.",
    inputSchema: z.object({
      project_id: z.union([z.string(), z.number()]).describe("Project ID or path"),
