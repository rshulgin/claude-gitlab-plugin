...
export const mergeRequestTools = (client: GitLabClient) => [
  {
    name: "gitlab_list_merge_requests",
    description:
      "List merge requests in a GitLab project. Supports filtering by state, source/target branch, and more.",
...

  {
    ...
    description:
      "Get details of a specific merge request by its internal ID (IID).",
    inputSchema: z.object({
    ...
    handler: async (input: { project_id: string | number; mr_iid: number }) => {
...

  {
    ...
    description:
      "Update an existing merge request. Can change title, description, state, labels, and more.",
    inputSchema: z.object({
      project_id: z.union([z.string(), z.number()]).describe("Project ID or path"),
...

  {
    ...
    handler: async (input: {
      ...
      return client.createMergeRequestNote(
        input.project_id,
        input.mr_iid,
        input.body
      );
