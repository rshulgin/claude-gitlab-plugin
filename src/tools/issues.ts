...
export const issueTools = (client: GitLabClient) => [
  {
    name: "gitlab_list_issues",
    description:
      "List issues in a GitLab project. Supports filtering by state, labels, assignee, and more.",
...

  {
    ...
    description:
      "Update an existing issue. Can change title, description, state, labels, and more.",
    inputSchema: z.object({
      project_id: z.union([z.string(), z.number()]).describe("Project ID or path"),
